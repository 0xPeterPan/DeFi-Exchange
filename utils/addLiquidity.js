...
export const calculateCD = async (
  ...
  // The ratio we follow is (amount of Crypto Devil tokens to be added) / (Crypto Devil tokens balance) = (Eth that would be added) / (Eth reserve in the contract)
  // So by maths we get (amount of Crypto Devil tokens to be added) = (Eth that would be added * Crypto Devil tokens balance) / (Eth reserve in the contract)

  const cryptoDevilTokenAmount = _addEtherAmountWei
    .mul(cdTokenReserve)
    .div(etherBalanceContract);
  return cryptoDevilTokenAmount;
};